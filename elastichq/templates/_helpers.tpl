...
{{ include "elastichq.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "elastichq.selectorLabels" -}}
...
*/}}
{{- define "elastichq.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "elastichq.fullname" .) .Values.serviceAccount.name }}
{{- else }}
